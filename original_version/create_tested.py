...
def save_images( visuals,namen,MC4BS, aspect_ratio=1.0, width=256):
    ...
    for label, im_data in visuals.items():
        ...
        save_path = "/home/andrea/Documents/NCTU/pytorch-CycleGAN-and-pix2pix/datasets/facades/create/"+namen #in our case its BB.jpg
        h, w, _ = im.shape
        if aspect_ratio > 1.0:
        ...
        if "fake" in label:
            ...
            if second_cycle == False:
                ...
                img_p = image_tot_mod
                img_o = original_img
                pathpath = "/home/andrea/Documents/NCTU/pytorch-CycleGAN-and-pix2pix/datasets/facades/snap_collection/"+str(number)+".jpg"
...
def get_focused_squared_data(img,xmin,ymin,xmax,ymax, name, original_img,
    ...
    cv2.imwrite("/home/andrea/Documents/NCTU/pytorch-CycleGAN-and-pix2pix/datasets/facades/test/AB.jpg",vis)
...
if __name__ == '__main__':
   ...
   # noturn_image = cv2.imread("/home/andrea/Documents/NCTU/plain_images/ntr.png", -1) 
    ...
    folder_path = "datasets/facades/test/"
