...
def get_coordinates_mod(lines):
    ...
    for number, name in lines :
        ...
        #name = name[:-1]
        coordinates = extract_coordinates(name,coordinates, modd = True) 
#IF WANT TO SMOOTH:            
    coordinates = average_coordinates(coordinates)
    return coordinates
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
def brightening():
    intera = cv2.imread("/home/andrea/Documents/NCTU/pytorch-CycleGAN-and-pix2pix/datasets/facades/test/AB.jpg")
    img_original_real = intera[:,0:256]
    img_original_paste = cv2.imread("/home/andrea/Documents/NCTU/pytorch-CycleGAN-and-pix2pix/datasets/sbatta/AB.jpg")
    img_modified_fake = intera[:,256:]
    img_modified_gan =  cv2.imread("/home/andrea/Documents/NCTU/pytorch-CycleGAN-and-pix2pix/datasets/facades/create/BB.jpg")
    ...
    cv2.imwrite("/home/andrea/Documents/NCTU/pytorch-CycleGAN-and-pix2pix/datasets/facades/create/BB.jpg",result)
    
    #To check that it's right!    
    final = np.concatenate((img_modified_gan, result), axis=1)
    cv2.imwrite("/home/andrea/Documents/NCTU/pytorch-CycleGAN-and-pix2pix/datasets/CHECK/BB.jpg", final)
...
def create_video() :   
    ...
    path = "/home/andrea/Documents/NCTU/pytorch-CycleGAN-and-pix2pix/datasets/risu/"
    F = open('1/ImageSets/1.txt','r')
    lines = F.readlines()
    for name in lines :
        number = int(name[3:])
